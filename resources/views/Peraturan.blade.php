...
<!-- Judul Halaman -->
@section('judul_halaman', 'Peraturan')
            ...
            <div class="col-4">
                ...
                <div class="accordion accordion-wrapper" id="accordionExample">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div class="card-body mb-1">
                        <ul class="unordered-list bullet-primary">
                            <li><a href="#">Peraturan Daerah (58)</a></li>
                            <li><a href="#">Peraturan Gubernur (41)</a></li>
                            <li><a href="#">Peraturan Daerah (58)</a></li>
                            <li><a href="#">Peraturan Gubernur (41)</a></li>
                            <li><a href="#">Peraturan Daerah (58)</a></li>
                            <li><a href="#">Peraturan Gubernur (41)</a></li>
            ...
            <div class="col-8">
                ...
                <div class="card">
                    ...
                    <div class="post-header">
                        ...
                        <!-- /.post-category -->
                        <h2 class="post-title h3 mt-1 mb-3"><a href="/beranda/peraturan/detail" class="hover" rel="category">Peraturan Daerah Nomor 2 Tahun 2021</a></h2>
                    </div>
